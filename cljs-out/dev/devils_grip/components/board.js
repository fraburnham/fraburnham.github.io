...
devils_grip.components.board.card = (function devils_grip$components$board$card(p__13569,offset){
var vec__13570 = p__13569;
var suit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13570,(0),null);
var rank = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13570,(1),null);
...
devils_grip.components.board.cell = (function devils_grip$components$board$cell(p__13576,row_num,col_num,cell_cards){
var map__13577 = p__13576;
var map__13577__$1 = cljs.core.__destructure_map(map__13577);
var advance_action_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13577__$1,cljs.core.cst$kw$advance_DASH_action_BANG_);
var selection_click_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13577__$1,cljs.core.cst$kw$selection_DASH_click_BANG_);
var drag_end_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13577__$1,cljs.core.cst$kw$drag_DASH_end_BANG_);
var drag_start_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13577__$1,cljs.core.cst$kw$drag_DASH_start_BANG_);
var drop_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13577__$1,cljs.core.cst$kw$drop_BANG_);
var double_click_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13577__$1,cljs.core.cst$kw$double_DASH_click_BANG_);
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 7, [cljs.core.cst$kw$class,"cell",cljs.core.cst$kw$id,cell_id,cljs.core.cst$kw$on_DASH_double_DASH_click,(function (){var G__13578 = cljs.core.cst$kw$board;
var G__13579 = "cell";
var G__13580 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [row_num,col_num], null);
return (double_click_BANG_.cljs$core$IFn$_invoke$arity$3 ? double_click_BANG_.cljs$core$IFn$_invoke$arity$3(G__13578,G__13579,G__13580) : double_click_BANG_.call(null,G__13578,G__13579,G__13580));
})(),cljs.core.cst$kw$on_DASH_drag_DASH_over,(function (p1__13573_SHARP_){
return p1__13573_SHARP_.preventDefault();
...
}),cljs.core.cst$kw$on_DASH_drop,(function (){var G__13581 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [row_num,col_num], null);
return (drop_BANG_.cljs$core$IFn$_invoke$arity$1 ? drop_BANG_.cljs$core$IFn$_invoke$arity$1(G__13581) : drop_BANG_.call(null,G__13581));
})()], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$class,"drag-container",cljs.core.cst$kw$id,["drag-row-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(row_num),"-col-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col_num)].join(''),cljs.core.cst$kw$draggable,true,cljs.core.cst$kw$on_DASH_drag_DASH_start,(function (){var G__13582 = cljs.core.cst$kw$board;
var G__13583 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [row_num,col_num], null);
return (drag_start_BANG_.cljs$core$IFn$_invoke$arity$2 ? drag_start_BANG_.cljs$core$IFn$_invoke$arity$2(G__13582,G__13583) : drag_start_BANG_.call(null,G__13582,G__13583));
})(),cljs.core.cst$kw$on_DASH_drag_DASH_end,(drag_end_BANG_.cljs$core$IFn$_invoke$arity$2 ? drag_end_BANG_.cljs$core$IFn$_invoke$arity$2("drag-container","drop-target") : drag_end_BANG_.call(null,"drag-container","drop-target"))], null),cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__13574_SHARP_,p2__13575_SHARP_){
return devils_grip.components.board.card(p1__13574_SHARP_,p2__13575_SHARP_);
...
devils_grip.components.board.board = (function devils_grip$components$board$board(state_fns,p__13584){
var map__13585 = p__13584;
var map__13585__$1 = cljs.core.__destructure_map(map__13585);
var board_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13585__$1,cljs.core.cst$kw$board_DASH_state);
...
devils_grip.components.board.stock = (function devils_grip$components$board$stock(p__13586,p__13587){
var map__13588 = p__13586;
var map__13588__$1 = cljs.core.__destructure_map(map__13588);
var drag_start_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13588__$1,cljs.core.cst$kw$drag_DASH_start_BANG_);
var drag_end_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13588__$1,cljs.core.cst$kw$drag_DASH_end_BANG_);
var draw_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13588__$1,cljs.core.cst$kw$draw_BANG_);
var map__13589 = p__13587;
var map__13589__$1 = cljs.core.__destructure_map(map__13589);
var stock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13589__$1,cljs.core.cst$kw$stock);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [devils_grip.components.drag.draggable,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$on_DASH_drag_DASH_start,(function (){var G__13590 = cljs.core.cst$kw$stock;
var G__13591 = null;
return (drag_start_BANG_.cljs$core$IFn$_invoke$arity$2 ? drag_start_BANG_.cljs$core$IFn$_invoke$arity$2(G__13590,G__13591) : drag_start_BANG_.call(null,G__13590,G__13591));
...
devils_grip.components.board.talon = (function devils_grip$components$board$talon(p__13592,p__13593){
var map__13594 = p__13592;
var map__13594__$1 = cljs.core.__destructure_map(map__13594);
var drag_start_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13594__$1,cljs.core.cst$kw$drag_DASH_start_BANG_);
var drag_end_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13594__$1,cljs.core.cst$kw$drag_DASH_end_BANG_);
var drop_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13594__$1,cljs.core.cst$kw$drop_BANG_);
var double_click_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13594__$1,cljs.core.cst$kw$double_DASH_click_BANG_);
var map__13595 = p__13593;
var map__13595__$1 = cljs.core.__destructure_map(map__13595);
var talon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13595__$1,cljs.core.cst$kw$talon);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$id,"talon"], null),cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [devils_grip.components.drag.draggable,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$on_DASH_drag_DASH_start,(function (){var G__13596 = cljs.core.cst$kw$talon;
var G__13597 = null;
return (drag_start_BANG_.cljs$core$IFn$_invoke$arity$2 ? drag_start_BANG_.cljs$core$IFn$_invoke$arity$2(G__13596,G__13597) : drag_start_BANG_.call(null,G__13596,G__13597));
})(),cljs.core.cst$kw$on_DASH_drag_DASH_end,(drag_end_BANG_.cljs$core$IFn$_invoke$arity$2 ? drag_end_BANG_.cljs$core$IFn$_invoke$arity$2("drag-container","drop-target") : drag_end_BANG_.call(null,"drag-container","drop-target")),cljs.core.cst$kw$on_DASH_double_DASH_click,(function (){var G__13598 = cljs.core.cst$kw$talon;
var G__13599 = "drag-container";
var G__13600 = null;
return (double_click_BANG_.cljs$core$IFn$_invoke$arity$3 ? double_click_BANG_.cljs$core$IFn$_invoke$arity$3(G__13598,G__13599,G__13600) : double_click_BANG_.call(null,G__13598,G__13599,G__13600));
})()], null),cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [devils_grip.components.drag.drop_target,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$on_DASH_drag_DASH_enter,(function (event){
return event.target.classList.add("drop-target");
}),cljs.core.cst$kw$on_DASH_drag_DASH_exit,(function (event){
return (event.target.classList = "card");
}),cljs.core.cst$kw$on_DASH_drop,(function (){var G__13601 = cljs.core.cst$kw$talon;
return (drop_BANG_.cljs$core$IFn$_invoke$arity$1 ? drop_BANG_.cljs$core$IFn$_invoke$arity$1(G__13601) : drop_BANG_.call(null,G__13601));
...
devils_grip.components.board.score = (function devils_grip$components$board$score(p__13602){
var map__13603 = p__13602;
var map__13603__$1 = cljs.core.__destructure_map(map__13603);
var state_map = map__13603__$1;
var stock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13603__$1,cljs.core.cst$kw$stock);
var talon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13603__$1,cljs.core.cst$kw$talon);
