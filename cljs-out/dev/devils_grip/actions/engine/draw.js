...
var hierarchy__4705__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,(function (){var fexpr__13445 = cljs.core.get_global_hierarchy;
return (fexpr__13445.cljs$core$IFn$_invoke$arity$0 ? fexpr__13445.cljs$core$IFn$_invoke$arity$0() : fexpr__13445.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("devils-grip.actions.engine.draw","advance"),(function (p__13446){
var map__13447 = p__13446;
var map__13447__$1 = cljs.core.__destructure_map(map__13447);
var stock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13447__$1,cljs.core.cst$kw$stock);
...
devils_grip.actions.engine.draw.advance.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$stock_DASH_full,(function (state_map__13405__auto__){
var fexpr__13448 = (function (state_map){
...
return fexpr__13448(state_map__13405__auto__);
}));

devils_grip.actions.engine.draw.advance.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$stock_DASH_empty,(function (state_map__13405__auto__){
var fexpr__13452 = (function (p__13453){
var map__13454 = p__13453;
var map__13454__$1 = cljs.core.__destructure_map(map__13454);
var state_map = map__13454__$1;
...
var G__13455 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(state_map,cljs.core.cst$kw$stock,(function (p1__13444_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(p1__13444_SHARP_,talon);
})),cljs.core.cst$kw$talon,cljs.core.constantly(cljs.core.PersistentVector.EMPTY));
return (devils_grip.actions.engine.draw.advance.cljs$core$IFn$_invoke$arity$1 ? devils_grip.actions.engine.draw.advance.cljs$core$IFn$_invoke$arity$1(G__13455) : devils_grip.actions.engine.draw.advance.call(null,G__13455));
});
return fexpr__13452(state_map__13405__auto__);
}));

devils_grip.actions.engine.draw.advance.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$default,(function (state_map__13405__auto__){
var fexpr__13456 = (function (state_map){
...
return fexpr__13456(state_map__13405__auto__);
}));
