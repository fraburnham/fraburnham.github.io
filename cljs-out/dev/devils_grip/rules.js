...
var G__13389 = cljs.core.rest(cards);
return (devils_grip.rules.valid_gap_QMARK_.cljs$core$IFn$_invoke$arity$1 ? devils_grip.rules.valid_gap_QMARK_.cljs$core$IFn$_invoke$arity$1(G__13389) : devils_grip.rules.valid_gap_QMARK_.call(null,G__13389));
} else {
return false;
}
}
...
return cljs.core.every_QMARK_((function (p1__13390_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(suit,cljs.core.first(p1__13390_SHARP_));
}),cards);
});
...
return cljs.core.every_QMARK_(cljs.core.true_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13391_SHARP_){
var fexpr__13392 = cljs.core.cst$kw$fn.cljs$core$IFn$_invoke$arity$1(p1__13391_SHARP_);
return (fexpr__13392.cljs$core$IFn$_invoke$arity$1 ? fexpr__13392.cljs$core$IFn$_invoke$arity$1(cards) : fexpr__13392.call(null,cards));
...
devils_grip.rules.validate_board = (function devils_grip$rules$validate_board(p__13393){
var map__13394 = p__13393;
var map__13394__$1 = cljs.core.__destructure_map(map__13394);
var board_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13394__$1,cljs.core.cst$kw$board_DASH_state);
