...
goog.require('devils_grip.actions.helpers');
...
}),cljs.core.cst$kw$selection_DASH_click_BANG_,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(devils_grip.actions.helpers.selection_click_BANG_,devils_grip.core.state_map),cljs.core.cst$kw$set_DASH_action_BANG_,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(devils_grip.actions.helpers.set_action_BANG_,devils_grip.core.state_map),cljs.core.cst$kw$double_DASH_click_BANG_,devils_grip.actions.helpers.double_click_BANG_(devils_grip.core.state_map),cljs.core.cst$kw$draw_BANG_,devils_grip.actions.helpers.draw_BANG_(devils_grip.core.state_map),cljs.core.cst$kw$drag_DASH_end_BANG_,devils_grip.actions.helpers.drag_end_BANG_(devils_grip.core.state_map),cljs.core.cst$kw$drag_DASH_start_BANG_,devils_grip.actions.helpers.drag_start_BANG_(devils_grip.core.state_map),cljs.core.cst$kw$drop_BANG_,devils_grip.actions.helpers.drop_BANG_(devils_grip.core.state_map)], null);
