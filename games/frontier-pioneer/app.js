...
var $author$project$Rules$movementDistanceModifier = F2(
	function (effects, distance) {
		return A3(
			...
			$author$project$Rules$movementImproved(effects),
			$author$project$Rules$movementImpaired(effects),
			distance);
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onClick($author$project$Types$RollDice)
				]),
			_List_fromArray(
				[
...
var $author$project$View$Board$actionHint = function (text) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('flex italic font-medium text-center items-center justify-center h-[5rem] w-full wrap')
			]),
		_List_fromArray(
			[
...
var $author$project$View$Board$anomalyMessage = F2(
	function (model, t) {
		...
		switch (_v0) {
			...
			case 3:
				return 'You have encountered an asteroid shower. Your ship suffered ' + ($elm$core$String$fromInt(
			...
			case 6:
				return 'You have encountered an alien signal. It disrupted your scanners. You will not be able to scan for resources or map sectors next turn.';
			case 7:
				return 'You have encountered a alien vessel. They attack your ship. Your ship suffers ' + ($elm$core$String$fromInt(
					A2($author$project$Data$Damage$damageAmount, model, t)) + ' damage.');
			case 8:
				return 'You have encountered pirates. They have pillaged several nearby sectors of resources.';
			default:
				return 'You have encountered an anomaly.';
		}
	});
var $author$project$Types$D10 = 3;
var $author$project$Types$D12 = 4;
var $author$project$Types$D20 = 5;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('border-b-1 border-black/50 font-light')
						]),
					_List_fromArray(
						[
...
var $author$project$View$Board$dieStyle = F2(
	function (model, d) {
		var inactiveStyle = 'blur-[1px] opacity-50';
		var activeStyle = '';
		var _v0 = model.a1;
		if (_v0.$ === 1) {
...
var $author$project$View$Board$dice = function (model) {
	var style = $author$project$View$Board$dieStyle(model);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('flex h-[4rem] items-center text-center justify-around')
			]),
		function () {
			var _v0 = model.a1;
			if (_v0.$ === 1) {
...
var $author$project$View$Board$activeAction = F2(
	function (model, t) {
		...
		switch (_v0.$) {
			...
			case 0:
				var spacesLeft = _v0.a;
				return _List_fromArray(
					[
						$author$project$View$Board$actionHint(
						'Select your next sector. You cannot move diagonally. You have ' + ($elm$core$String$fromInt(spacesLeft) + ' moves left.'))
					]);
			case 1:
				return _List_fromArray(
					[
			...
			default:
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('flex items-center h-[5rem]')
							]),
						_List_fromArray(
							[
								$author$project$View$Board$actionHint(
								A2($author$project$View$Board$anomalyMessage, model, t))
							])),
						$author$project$View$Board$actionButtons(model)
					]);
		}
...
var $author$project$View$Board$calcScore = function (model) {
	return ((((model.F.av + model.F.a_) + model.F.aX) + model.F.aW) + ($elm$core$List$length(model.aH) * 10)) + A3(
		...
		F2(
			function (row, total) {
				return total + A3($elm$core$Array$foldl, $elm$core$Basics$add, 0, row);
			}),
		0,
		A2(
			$author$project$Data$Sector$sectorMap,
			F2(
				function (coords, sector) {
					if (sector.$ === 1) {
						return 0;
					} else {
						return 1;
...
var $author$project$View$Board$collectResourceButton = F3(
	function (l, r, applyTo) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					$author$project$Data$Upgrade$upgradeToName(applyTo))
				]));
	});
var $author$project$View$Board$collectResourceButtons = F2(
	function (l, r) {
		var terraformingTech = A3($author$project$View$Board$collectResourceButton, l, r, 1);
		var shipRepairs = A3($author$project$View$Board$collectResourceButton, l, r, 2);
		var scannerTech = A3($author$project$View$Board$collectResourceButton, l, r, 3);
		var blinkDrive = A3($author$project$View$Board$collectResourceButton, l, r, 0);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			function () {
				...
				switch (_v0) {
					...
					case 1:
						return _List_fromArray(
							[blinkDrive, terraformingTech, shipRepairs, scannerTech]);
					case 2:
						return _List_fromArray(
							[terraformingTech]);
					case 3:
						return _List_fromArray(
							[terraformingTech, shipRepairs]);
					case 4:
						return _List_fromArray(
							[shipRepairs, scannerTech]);
					case 5:
						return _List_fromArray(
							[blinkDrive]);
					default:
						return _List_fromArray(
							[blinkDrive, scannerTech]);
				}
			}());
	});
			...
			if (_v0.$ === 1) {
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('flex italic font-medium text-center items-center justify-center h-full w-full')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Select a starting sector to begin.')
							]))
					]);
			} else {
				var l = _v0.a;
				var _v1 = $author$project$Data$Sector$getCurrentSector(model);
				if (_v1.$ === 1) {
...
var $author$project$View$Board$header = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('font-[Russo_One] text-4xl text-center pt-2 text-shadow-xs')
		]),
	_List_fromArray(
		[
			$elm$html$Html$text('Frontier Pioneer')
		]));
...
var $author$project$Data$Resource$resourceKindToName = function (rk) {
	switch (rk) {
		...
		case 5:
			return 'Dark Matter';
		default:
			return 'Exotic Minerals';
	}
};
var $author$project$Data$Resource$resourceKindToSymbol = function (rk) {
	switch (rk) {
		case 0:
			return 'X';
		case 1:
...
var $author$project$View$Map$sectorBoxStyle = 'h-[1.5rem] w-[1.5rem] flex items-center justify-center';
var $author$project$Data$Sector$sectorKindToName = function (sk) {
	switch (sk) {
		case 0:
			return 'Deep Space';
		case 1:
			return 'Colonized Star System';
		case 2:
			return 'Uncolonized Star System';
		case 3:
			return 'Nebula';
		default:
			return 'Enemy Space';
...
var $author$project$Data$Sector$sectorKindToSymbol = function (sk) {
	switch (sk) {
		case 0:
			return 'D';
		case 2:
...
var $author$project$View$Map$sectorRowStyle = function (s) {
	if (s.$ === 1) {
		return 'flex flex-row divide-x-1 divide-gray-300';
	} else {
		return 'flex flex-row divide-x-1 divide-gray-500';
	}
};
...
var $author$project$View$Map$sectorStyle = F4(
	function (model, col, row, s) {
		return A2(
			$elm$core$String$join,
			' ',
			_List_fromArray(
				[
					...
					A2($author$project$View$Map$sectorStyleMapped, model, s),
					A3($author$project$View$Map$sectorStyleCurrentLocation, model, col, row),
					A4($author$project$View$Map$sectorStyleValidForAction, model, col, row, s)
				]));
	});
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class(sectorRowStyleResolved)
							]),
						_List_fromArray(
							[
								A2(
...
var $author$project$View$Map$mapRow = F3(
	function (model, row, sectors) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('flex flex-row divide-x-1 size-fit')
				]),
			$elm$core$Array$toList(
				A2(
					$elm$core$Array$indexedMap,
					A2($author$project$View$Map$sector, model, row),
					sectors)));
	});
var $author$project$View$Map$map = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('map'),
				$elm$html$Html$Attributes$class('flex flex-col border-1 divide-y-1 size-fit m-2 bg-sky-50')
			]),
		$elm$core$Array$toList(
			A2(
				$elm$core$Array$indexedMap,
...
var $author$project$View$Board$board = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Types$Unmapped = {$: 1};
var $author$project$Types$maxSectorCol = 12;
var $author$project$Types$maxSectorRow = 12;
...
var $author$project$Main$initialSectors = A2(
...
var $author$project$Update$handleDamage = F2(
	function (model, t) {
		return _Utils_update(
			model,
			{
...
var $author$project$Types$Discovered = function (a) {
	return {$: 0, a: a};
};
var $author$project$Types$Mapped = function (a) {
	return {$: 0, a: a};
};
var $author$project$Update$Resource$resourceMap = F2(
	function (fn, sectors) {
		return A2(
			$elm$core$Array$indexedMap,
			F2(
...
var $author$project$Update$setTemporaryEffect = F2(
	function (model, eff) {
		return _Utils_update(
			model,
			{
				aZ: $elm$core$Maybe$Just(eff)
			});
	});
var $author$project$Update$updateTurnStateAction = F2(
			...
			if (_v2.$ === 3) {
				...
				switch (_v3) {
					...
					case 2:
						return _Utils_Tuple2(
							A2(
								$author$project$Update$setTemporaryEffect,
								model,
								$author$project$Types$ScanningImpaired(
									{E: false})),
							$elm$core$Platform$Cmd$none);
					...
					case 5:
						return _Utils_Tuple2(
							A2($author$project$Update$setTemporaryEffect, model, $author$project$Types$MovementImpaired),
							$elm$core$Platform$Cmd$none);
					case 6:
						return _Utils_Tuple2(
							A2(
...
var $author$project$Update$handleUpgradeProgress = F4(
	function (upgrade, data, location, model) {
		var totalProgress = model.F;
...
var $author$project$Update$enemySector = F2(
	function (maybeSector, damage) {
		if (maybeSector.$ === 1) {
			return damage;
		} else {
			var sector = maybeSector.a;
			if (sector.$ === 1) {
				return damage;
			} else {
				var s = sector.a;
...
var $author$project$Types$ColonizedSystem = 1;
var $author$project$Types$DeepSpace = 0;
var $author$project$Types$EnemySpace = 4;
var $author$project$Types$Nebula = 3;
var $author$project$Types$UncolonizedSystem = 2;
var $author$project$Data$Sector$intToSectorKind = function (i) {
	switch (i) {
		case 2:
			return 1;
		case 3:
...
var $author$project$Update$Sector$mapSector = F2(
	function (t, sector) {
		if (!sector.$) {
			var s = sector.a;
...
var $author$project$Types$ResourceDiscoveryImproved = {$: 3};
var $author$project$Update$Resource$resourceDiscoveryCount = function (activeEffects) {
...
var $author$project$Update$Resource$shipRepairs = function (activeEffects) {
	var _v0 = A2($elm$core$List$member, $author$project$Types$ShipImproved, activeEffects);
	if (!_v0) {
		return $elm$core$Basics$identity;
	} else {
		return function (c) {
...
var $author$project$Update$Resource$resourceScan = F3(
	function (activeEffects, t, sector) {
		var count = A2(
			$elm$core$Basics$composeL,
			$author$project$Update$Resource$shipRepairs(activeEffects),
			$author$project$Update$Resource$resourceDiscoveryCount(activeEffects))(t);
		if (sector.$ === 1) {
...
var $author$project$Types$ScanningImproved = {$: 4};
var $author$project$Update$Sector$arrayUpdate = F3(
	function (i, updateFn, arr) {
...
var $author$project$Update$Sector$updateSector = F3(
...
var $author$project$Types$numResourcesToUpgrade = 20;
var $author$project$Data$Upgrade$upgradeProgress = F2(
...
var $author$project$Data$Upgrade$upgradeToEffect = function (upgrade) {
	switch (upgrade) {
		case 0:
			return $author$project$Types$MovementImproved;
		case 1:
			return $author$project$Types$ResourceDiscoveryImproved;
		case 2:
			return $author$project$Types$ShipImproved;
		default:
			return $author$project$Types$ScanningImproved;
	}
};
...
var $author$project$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 2:
				var result = msg.a;
				return $author$project$Update$handleAnomaly(
					_Utils_update(
						model,
						{
							a1: $elm$core$Maybe$Just(
