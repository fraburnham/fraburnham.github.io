...
devils_grip.actions.engine.drag.talon.advance = (function (){var method_table__4701__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"devils-grip.actions.engine.drag.talon","advance"),(function (p__9569){
var map__9570 = p__9569;
var map__9570__$1 = cljs.core.__destructure_map.call(null,map__9570);
var action_state = cljs.core.get.call(null,map__9570__$1,new cljs.core.Keyword(null,"action-state","action-state",-1575944631));
...
cljs.core._add_method.call(null,devils_grip.actions.engine.drag.talon.advance,(0),(function (state_map__9489__auto__){
...
cljs.core._add_method.call(null,devils_grip.actions.engine.drag.talon.advance,(1),(function (state_map__9489__auto__){
return (function (state_map){
return state_map;
}).call(null,state_map__9489__auto__);
}));

cljs.core._add_method.call(null,devils_grip.actions.engine.drag.talon.advance,(2),(function (state_map__9489__auto__){
return (function (state_map){
return devils_grip.actions.engine.from_talon.advance.call(null,cljs.core.update_in.call(null,state_map,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"action-state","action-state",-1575944631),new cljs.core.Keyword(null,"selections","selections",-1277610233)], null),cljs.core.rest));
}).call(null,state_map__9489__auto__);
}));

cljs.core._add_method.call(null,devils_grip.actions.engine.drag.talon.advance,new cljs.core.Keyword(null,"default","default",-1987822328),(function (state_map__9489__auto__){
return (function (state_map){
