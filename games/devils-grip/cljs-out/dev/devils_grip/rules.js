...
var G__10777 = cljs.core.rest(cards);
return (devils_grip.rules.valid_gap_QMARK_.cljs$core$IFn$_invoke$arity$1 ? devils_grip.rules.valid_gap_QMARK_.cljs$core$IFn$_invoke$arity$1(G__10777) : devils_grip.rules.valid_gap_QMARK_.call(null,G__10777));
} else {
return false;
}
}
...
return cljs.core.every_QMARK_((function (p1__10778_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(suit,cljs.core.first(p1__10778_SHARP_));
}),cards);
});
...
return cljs.core.every_QMARK_(cljs.core.true_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10779_SHARP_){
var fexpr__10780 = cljs.core.cst$kw$fn.cljs$core$IFn$_invoke$arity$1(p1__10779_SHARP_);
return (fexpr__10780.cljs$core$IFn$_invoke$arity$1 ? fexpr__10780.cljs$core$IFn$_invoke$arity$1(cards) : fexpr__10780.call(null,cards));
...
devils_grip.rules.validate_board = (function devils_grip$rules$validate_board(p__10781){
var map__10782 = p__10781;
var map__10782__$1 = cljs.core.__destructure_map(map__10782);
var board_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10782__$1,cljs.core.cst$kw$board_DASH_state);
