...
var G__13618 = o;
(G__13618[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__13624 = jsprops;
(G__13624["defaultValue"] = value);

(G__13624["onChange"] = ((function (G__13624,v,value,on_change){
return (function (p1__13623_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13623_SHARP_);
});})(G__13624,v,value,on_change))
);
...
var vec__13627 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13627,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13627,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13627,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13631 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13631 == null)){
} else {
var key_13632 = temp__4661__auto___13631;
(jsprops["key"] = key_13632);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13633 = reagent.impl.template.__GT_NativeWrapper();
(G__13633["name"] = c);
...
var G__13634 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13634) : reagent.impl.template.as_element.call(null,G__13634));
} else {
...
var len__8828__auto___13638 = arguments.length;
var i__8829__auto___13639 = (0);
while(true){
if((i__8829__auto___13639 < len__8828__auto___13638)){
args__8835__auto__.push((arguments[i__8829__auto___13639]));

var G__13640 = (i__8829__auto___13639 + (1));
i__8829__auto___13639 = G__13640;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13636){
var G__13637 = cljs.core.first(seq13636);
var seq13636__$1 = cljs.core.next(seq13636);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13637,seq13636__$1);
});
...
break;
default:
var G__13643 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13643;
continue;
...
var n__8615__auto___13645 = a.length;
var i_13646 = (0);
while(true){
if((i_13646 < n__8615__auto___13645)){
(a[i_13646] = reagent.impl.template.as_element((a[i_13646])));

var G__13647 = (i_13646 + (1));
i_13646 = G__13647;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8615__auto___13648 = a.length;
var i_13649 = (0);
while(true){
if((i_13649 < n__8615__auto___13648)){
var val_13650 = (a[i_13649]);
if((cljs.core.vector_QMARK_(val_13650)) && ((reagent.impl.template.key_from_vec(val_13650) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13649] = reagent.impl.template.as_element(val_13650));
...
var ctx = ({});
var vec__13652 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13652,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13652,(1),null);
...
var G__13655 = (cljs.core.count(argv) - first_child);
switch (G__13655) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13655){
